<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Gift Card',
            subtitle: 'Issue gift cards and vouchers and track their balance',
            breadcrumbs: [
                {
                    title: 'Gift Card',
                    href: 'NULL',
    ...
    const columns = computed(() => [
        ...
        { key: 'contact_name', label: 'Holder', type: 'secondary', responsive: ['sm', 'md', 'lg'], emptyDisplay: 'Bearer' },
        { key: 'balance', label: 'Balance', type: 'secondary', responsive: ['xs', 'sm', 'md', 'lg'] },
        { key: 'initial_value', label: 'Issued', type: 'secondary', responsive: ['md', 'lg'] },
    ...
    const debouncedGetGiftCards = debounce((params) => {
        getGiftCards(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetGiftCards({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetGiftCards({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.giftCards, () => state);
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-if="showCompanyFilter" v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="giftcard-filter-company">Company</label>
                    <select
                        id="giftcard-filter-company"
            ...
            <div class="admin-list-card__body">
                <div class="admin-list-table">
                    <TheTable
                        ...
                        :delete="deleteRecord"
                        actionType="link"
                        :viewRoute="(id: number) => `/giftcard/${id}/view`"
