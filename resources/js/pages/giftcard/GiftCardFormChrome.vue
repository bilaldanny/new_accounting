<script setup lang="ts">
    ...
    const listTitle = 'Gift Card';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Gift Card' : 'Add Gift Card'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Gift Card' : 'New Gift Card'));
</script>
