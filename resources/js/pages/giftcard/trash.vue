<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Gift Card Trash',
            subtitle: 'Restore or permanently delete removed gift cards',
            breadcrumbs: [
                {
                    title: 'Gift Card',
                    href: '/giftcard',
    ...
    const debouncedGetTrashGiftCards = debounce((params) => {
        getTrashGiftCards(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashGiftCards({ ...state.search });
            ...
            console.error('Error fetching trash gift cards:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashGiftCards({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.giftCards}/trash`, () => state);
</script>
