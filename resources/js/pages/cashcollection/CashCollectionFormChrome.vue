<script setup lang="ts">
    ...
    const listTitle = 'Cash Collection';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Cash Collection' : 'Add Cash Collection'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Cash Collection' : 'New Cash Collection'));
</script>
