<script setup lang="ts">
    ...
    const listTitle = 'Stock Transfer';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Stock Transfer' : 'Add Stock Transfer'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Stock Transfer' : 'New Stock Transfer'));
</script>
