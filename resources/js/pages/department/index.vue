<script setup lang="ts">
    ...
    const debouncedGetDepartments = debounce((params) => {
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetDepartments({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetDepartments({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.departments, () => state);
