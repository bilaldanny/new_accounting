<script setup lang="ts">
    ...
    const nameRules = computed(() => {
        if (params.recordId) {
            return `required|department_name_unique:${params.recordId}`;
        }

        return 'required|department_name_unique';
    });
    ...
    const branchInfo = computed(() =>
        isCompanyadmin.value
            ...
            : 'Optional. Select a company first when creating a branch-specific department.',
    );
...
<template>
    ...
    <SelectElement
        ...
        :floating="false"
        :can-clear="true"
        info="Optional. Leave empty for a global department."
    />
