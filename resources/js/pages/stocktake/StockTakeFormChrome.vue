<script setup lang="ts">
    ...
    const listTitle = 'Stock Take';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Stock Take' : 'Add Stock Take'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Stock Take' : 'New Stock Take'));
</script>
