<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Stock Take Trash',
            subtitle: 'Restore or permanently delete removed stock takes',
            breadcrumbs: [
                {
                    title: 'Stock Take',
                    href: '/stocktake',
    ...
    const debouncedGetTrashStockTakes = debounce((params) => {
        getTrashStockTakes(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashStockTakes({ ...state.search });
            ...
            console.error('Error fetching trash stock takes:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashStockTakes({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.stockTakes}/trash`, () => state);
</script>
