<script setup lang="ts">
    ...
    const listTitle = 'Bank Issuer';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Bank Issuer' : 'Add Bank Issuer'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Bank Issuer' : 'New Bank Issuer'));
</script>
