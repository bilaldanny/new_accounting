...
<template>
    <Head :title="`View ${formatedText('expense')}`" />

    <div class="product-form-page purchase-approval-page journal-view-page">
        <div class="product-form">
            <Loader v-if="!pageReady" message="Loading expense…" />

            <article v-else class="purchase-approval-doc" id="expense-print">
                <header class="purchase-approval-doc__header">
                    <div>
                        <p class="purchase-approval-doc__eyebrow">Expense voucher</p>
                        <h2 class="purchase-approval-doc__title">{{ formData.voucher_no || 'Expense' }}</h2>
            ...
            <div class="product-form-page__footer purchase-approval-page__footer">
                <div class="product-form-page__actions">
                    ...
                    <button
                        ...
                        :disabled="!pageReady"
                        @click="router.visit(`/expense/${recordId}/edit`)"
                    >
                        Edit
                    </button>
