<script setup lang="ts">
    ...
    const listTitle = 'Price List';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Price List' : 'Add Price List'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Price List' : 'New Price List'));
</script>
