<script setup lang="ts">
    ...
    const listTitle = 'Stock Adjustment';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Stock Adjustment' : 'Add Stock Adjustment'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Stock Adjustment' : 'New Stock Adjustment'));
</script>
