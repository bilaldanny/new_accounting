<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Restore or permanently delete removed stock adjustments',
            breadcrumbs: [
                {
    ...
    const debouncedGetTrashStockAdjustments = debounce((params) => {
        getTrashStockAdjustments(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashStockAdjustments({ ...state.search });
            ...
            console.error('Error fetching trash stock adjustments:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashStockAdjustments({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.stockAdjustments}/trash`, () => state);
</script>
