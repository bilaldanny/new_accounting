<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Restore or permanently delete removed categories',
            breadcrumbs: [
                {
    ...
    const debouncedGetTrashCategories = debounce((params) => {
        getTrashCategories(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashCategories({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashCategories({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.categories}/trash`, () => state);
