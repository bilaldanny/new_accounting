<script setup lang="ts">
    ...
    const debouncedGetCategories = debounce((params) => {
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetCategories({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetCategories({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.categories, () => state);
...
<template>
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-if="showFilter" v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                <div v-if="showCompanyFilter" class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="category-filter-company">Company</label>
                    <select
                        id="category-filter-company"
    ...
    <EditModal
        ...
        :endpoint="`${API_ENDPOINTS.categories}/${edit_id.id}`"
