<script setup lang="ts">
    ...
    const debouncedGetBrands = debounce((params) => {
    ...
    const getData = async () => {
        ...
        try {
            ...
            await debouncedGetBrands({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetBrands({ ...state.search });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.brands, () => state);
...
<template>
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-if="showFilter" v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                ...
                <div v-if="showCompanyFilter" class="col-md-4 col-lg-3 admin-filter-field">
                    ...
                    <label class="form-label" for="brand-filter-company">Company</label>

                    <select

                        id="brand-filter-company"
    ...
    <EditModal
        ...
        :endpoint="`${API_ENDPOINTS.brands}/${edit_id.id}`"
