<script setup lang="ts">
    ...
    const listTitle = 'Commission Agent';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Commission Agent' : 'Add Commission Agent'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Commission Agent' : 'New Commission Agent'));
</script>
