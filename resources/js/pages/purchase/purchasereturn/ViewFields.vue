...
type PurchaseReturnView = {
    ...
    purchaselines?: PurchaseReturnLine[];
};

defineProps<{
    note: PurchaseReturnView;
}>();
...
<template>
    <article class="purchase-approval-doc" id="purchase-return-print">
        <header class="purchase-approval-doc__header">
            <div>
                <p class="purchase-approval-doc__eyebrow">Purchase return</p>
                <h2 class="purchase-approval-doc__title">
                    {{ note.invoice_no ? `#${note.invoice_no}` : 'Purchase return' }}
                </h2>
