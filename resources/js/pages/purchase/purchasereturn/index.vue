<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Return received goods against purchase orders',
            breadcrumbs: [
                {
                    title: 'Purchase Return',
                    href: 'NULL',
    ...
    const { props } = usePage();
    const moduleUrl = 'purchase/return';
    ...
    const debouncedGetPurchaseReturns = debounce((params) => {
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetPurchaseReturns({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetPurchaseReturns({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.purchaseReturns, () => state);
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-if="showFilter" v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                <div v-if="showCompanyFilter" class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="purchase-return-filter-company">Company</label>
                    <select
                        id="purchase-return-filter-company"
                ...
                <div v-if="showBranchFilter" class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="purchase-return-filter-branch">Branch</label>
                    <select
                        id="purchase-return-filter-branch"
                        class="form-select form-select-sm"
                ...
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="purchase-return-filter-supplier">Business name</label>
                    <select
                        id="purchase-return-filter-supplier"
                        class="form-select form-select-sm"
                ...
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="purchase-return-filter-payment">Payment status</label>
                    <select id="purchase-return-filter-payment" class="form-select form-select-sm" v-model="state.search.payment_status">
                ...
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="purchase-return-filter-date">Purchase return date</label>
                    <input
                        id="purchase-return-filter-date"
                        type="date"
            ...
            <div class="admin-list-card__body">
                <div class="admin-list-table">
                    <TheTable
                        ...
                        :delete="deleteRecord"
                        :view-route="(id) => `/purchase/return/${id}/view`"
                        actionType="link"
                        :apiUrl="moduleUrl"
                        show-export
