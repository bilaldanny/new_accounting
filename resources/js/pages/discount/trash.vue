<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Restore or permanently delete removed discounts',
            breadcrumbs: [
                {
                    title: 'Discount',
                    href: '/discount',
    ...
    const debouncedGetTrashDiscounts = debounce((params) => {
        getTrashDiscounts(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashDiscounts({ ...state.search });
            ...
            console.error('Error fetching trash discounts:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashDiscounts({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.discounts}/trash`, () => state);
</script>
