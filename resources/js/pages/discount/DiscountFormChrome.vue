<script setup lang="ts">
    ...
    const listTitle = 'Discount';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Discount' : 'Add Discount'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Discount' : 'New Discount'));
</script>
