<script setup lang="ts">
    ...
    setLayoutProps({
        ...
        subtitle: 'Review transfer details, accounts, and attachments',
        breadcrumbs: [
            {
                title: 'Fund Transfer',
                href: '/fundtransfer',
...
<template>
    <Head :title="`View ${formatedText('fundtransfer')}`" />
    ...
    <div class="product-form-page purchase-approval-page journal-view-page">
        <div class="product-form">
            ...
            <article v-else class="purchase-approval-doc" id="fundtransfer-print">
                <header class="purchase-approval-doc__header">
                    <div>
                        <p class="purchase-approval-doc__eyebrow">Fund transfer voucher</p>
                        <h2 class="purchase-approval-doc__title">{{ formData.voucher_no || 'Fund Transfer' }}</h2>
            ...
            <div class="product-form-page__footer purchase-approval-page__footer">
                <div class="product-form-page__actions">
                    <button type="button" class="btn btn-light" @click="router.visit('/fundtransfer')">Close</button>
                    ...
                    <button
                        ...
                        :disabled="!pageReady"
                        @click="router.visit(`/fundtransfer/${recordId}/edit`)"
                    >
                        Edit
                    </button>
                </div>
