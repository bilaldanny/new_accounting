<script setup lang="ts">
    ...
    import { Package, SliderAlt, Store } from '@boxicons/vue';
...
<template>
    ...
    <StaticElement v-if="showCompanyField" name="section_scope" :columns="colFull">
        <div class="company-section-header company-section-header-primary">
            ...
            <div>
                ...
                <p class="company-section-subtitle mb-0">Assign this item type to the correct company workspace</p>
            </div>
        </div>
    </StaticElement>
    ...
    <SelectElement
        ...
        :can-clear="false"
        :rules="companyRules"
        info="Required. Item types are scoped to a single company."
    />
    ...
    <StaticElement name="section_details" :columns="colFull">
        <div class="company-section-header company-section-header-indigo company-section-header-spaced">
            ...
            <div>
                <h6 class="company-section-title mb-0">Item Type Details</h6>
                <p class="company-section-subtitle mb-0">Classification label used when creating products and variations</p>
            </div>
        </div>
    </StaticElement>
    ...
    <TextElement
        ...
        placeholder="e.g. Finished Goods, Raw Material, Service"
        :columns="colThird"
        autocomplete="off"
        :rules="nameRules"
        info="Use a short, descriptive name that your team will recognize in product forms."
    />
    ...
    <StaticElement name="section_settings" :columns="colFull">
        <div class="company-section-header company-section-header-teal company-section-header-spaced">
            ...
            <div>
                ...
                <p class="company-section-subtitle mb-0">Control whether this item type appears in product and variation forms</p>
            </div>
        </div>
    </StaticElement>
    ...
    <ToggleElement
        ...
        field-name="Active"
        name="active"
        label="Item Type Status"
        :true-value="true"
        :false-value="false"
        :default="true"
        info="Inactive item types are hidden from dropdowns when adding or editing products."
    />
</template>
