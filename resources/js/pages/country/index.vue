<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Manage countries used across the application',
            breadcrumbs: [
                {
                    title: 'Country Management',
                    href: 'NULL',
    ...
    const columns = [
        ...
        { key: 'iso2', label: 'ISO2', type: 'code', responsive: ['md', 'lg'] },
        { key: 'iso3', label: 'ISO3', type: 'secondary', responsive: ['lg'] },
        { key: 'phonecode', label: 'Phone', type: 'secondary', responsive: ['lg'] },
    ...
    const debouncedGetCountries = debounce((params) => {
        getCountries(params);
    }, 300);
    ...
    onMounted(() => {
        ...
        debouncedGetCountries({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.countries, () => state);
...
<template>
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="country-filter-status">Status</label>
                    <select
                ...
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="country-filter-records">Show records</label>
                    <select
                        id="country-filter-records"
                        class="form-select form-select-sm"
            ...
            <div class="admin-list-card__body">
                <Loader v-if="state.fetchingApi" message="Fetching countries from API…" :fields="6" />
    ...
    <EditModal
        ...
        :endpoint="`${API_ENDPOINTS.countries}/${edit_id.id}`"
