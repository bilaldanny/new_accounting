<script setup lang="ts">
    ...
    const listTitle = 'Consumer';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Consumer' : 'Add Consumer'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Consumer' : 'New Consumer'));
</script>
