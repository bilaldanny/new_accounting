<script setup lang="ts">
    ...
    const listTitle = 'Transporter';
    const crumbCurrent = computed(() => (props.mode === 'edit' ? 'Edit Transporter' : 'Add Transporter'));
    const pageTitle = computed(() => (props.mode === 'edit' ? 'Edit Transporter' : 'New Transporter'));
</script>
