<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Transporter Trash',
            subtitle: 'Restore or permanently delete removed transporters',
            breadcrumbs: [
                {
                    title: 'Transporter',
                    href: '/transporter',
    ...
    const debouncedGetTrashTransporters = debounce((params) => {
        getTrashTransporters(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashTransporters({ ...state.search });
            ...
            console.error('Error fetching trash transporters:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashTransporters({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.transporters}/trash`, () => state);
</script>
