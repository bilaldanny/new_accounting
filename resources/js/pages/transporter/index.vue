<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Transporter',
            subtitle: 'Manage the transporters who carry your goods',
            breadcrumbs: [
                {
                    title: 'Transporter',
                    href: 'NULL',
    ...
    const columns = computed(() => [
        ...
        { key: 'name', label: 'Transporter', type: 'primary', responsive: ['xs', 'sm', 'md', 'lg'] },
        { key: 'phone', label: 'Phone', type: 'secondary', responsive: ['sm', 'md', 'lg'], emptyDisplay: '-' },
        { key: 'vehicle_no', label: 'Vehicle No', type: 'secondary', responsive: ['sm', 'md', 'lg'], emptyDisplay: '-' },
    ...
    const debouncedGetTransporters = debounce((params) => {
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTransporters({ ...state.search });
    ...
    onMounted(async () => {
        ...
        debouncedGetTransporters({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(API_ENDPOINTS.transporters, () => state);
        ...
        <div class="admin-list-card">
            ...
            <TheFilter v-if="showCompanyFilter" v-model:open="filterOpen" :loading="state.loading" @clear="clearSearch" @search="getData">
                <div class="col-md-4 col-lg-3 admin-filter-field">
                    <label class="form-label" for="transporter-filter-company">Company</label>
                    <select
                        id="transporter-filter-company"
            ...
            <div class="admin-list-card__body">
                <div class="admin-list-table">
                    <TheTable
                        ...
                        :delete="deleteRecord"
                        actionType="link"
                        :viewRoute="(id: number) => `/transporter/${id}/view`"
