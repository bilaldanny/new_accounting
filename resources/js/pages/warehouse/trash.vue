<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Restore or permanently delete removed warehouses',
            breadcrumbs: [
                {
                    title: 'Warehouse',
                    href: '/warehouse',
    ...
    const debouncedGetTrashWarehouses = debounce((params) => {
        getTrashWarehouses(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashWarehouses({ ...state.search });
            ...
            console.error('Error fetching trash warehouses:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashWarehouses({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.warehouses}/trash`, () => state);
</script>
