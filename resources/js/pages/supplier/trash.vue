<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            ...
            subtitle: 'Restore or permanently delete removed suppliers',
            breadcrumbs: [
                {
    ...
    const debouncedGetTrashSuppliers = debounce((params) => {
        getTrashSuppliers(params);
    }, 300);
    ...
    const getData = async () => {
        try {
            ...
            await debouncedGetTrashSuppliers({ ...state.search });
            ...
            console.error('Error fetching supplier trash:', error);
        }
    };
    ...
    onMounted(async () => {
        ...
        debouncedGetTrashSuppliers({ ...state.search });
    });
    ...
    const fetchAllRowsForExport = createTableExportAllRows(`${API_ENDPOINTS.suppliers}/trash`, () => state);
</script>
