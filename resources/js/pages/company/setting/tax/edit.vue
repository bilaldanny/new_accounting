<script setup lang="ts">
    ...
    const modalProps = defineProps({
        ...
        groupFormData: { type: Object, required: true },
    ...
    const isGroup = computed(() => Number(modalProps.editType) === 1);
    const activeFormData = computed(() => (isGroup.value ? modalProps.groupFormData : modalProps.formData));
...
<template>
    <ModalComponent
        id="EditModal"
        :title="isGroup ? 'Edit Tax Group' : 'Edit Tax'"
    ...
    >
        ...
        >
            <GroupFields
                ...
                :form-data="modalProps.groupFormData"
                :form-ref="formRef"
