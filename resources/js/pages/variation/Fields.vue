<script setup lang="ts">
    ...
    function ensureDefaultValues() {
        ...
        if (! Array.isArray(params.formData?.values) || params.formData.values.length === 0) {
    ...
    async function handleCategoryChange(
        ...
        await loadSubcategoryOptions(companyId, normalizedCategoryId || undefined);
    ...
    function syncValues(values: Array<{ name: string; active: boolean | number | string }>) {
