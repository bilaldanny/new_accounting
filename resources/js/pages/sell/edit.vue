<script setup lang="ts">
    ...
    defineOptions({
        layout: {
            title: 'Edit Sell',
            subtitle: 'Update customer, items, shipping, and invoice totals',
            breadcrumbs: [
                {
    ...
    const { formData, getEditData } = useSells();
    ...
    const endpoint = computed(() => `${API_ENDPOINTS.sells}/${recordId.value}`);
