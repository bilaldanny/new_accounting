<script setup lang="ts">
    ...
    async function loadSell(transactionId: string | number | null | undefined) {
        ...
        try {
            const response = await window.axios.get(API_ENDPOINTS.sellPaymentSell(id));
...
<template>
    ...
    <SelectElement
        ...
        rules="required"
        info="Only sells with a remaining balance are listed."
    />
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                <div class="border rounded p-3 h-100">
                    <strong>Customer:</strong> {{ params.formData?.customer_name || '-' }}<br>
    ...
    <StaticElement name="document_upload" :columns="colQuarter" tag="div">
        <label class="form-label" for="SellPaymentDocument">Attachment</label>
        <input
            id="SellPaymentDocument"
