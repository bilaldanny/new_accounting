<script setup lang="ts">
    ...
    const emit = defineEmits<{
        ...
        update: [index: number, patch: Partial<SellLineRow>];
        remove: [index: number];
    }>();
    ...
    function packingLabel(line: SellLineRow): string {
    ...
    <div class="purchase-lines">
        ...
        <div v-if="isSearchBox && open && !disabled && (suggestions.length > 0 || query)" class="purchase-lines__results">
            ...
            >
                ...
                <span class="purchase-lines__result-price">{{ money(product.default_sell_price) }}</span>
            </button>
            ...
            <table class="pricing-table__grid">
                <thead>
                    <tr>
                        ...
                        <th class="is-money">Rate</th>
                        <th class="is-money">Discount</th>
                        <th class="is-money">Net rate</th>
                    ...
                    <tr v-for="(line, index) in lines" :key="line.id ?? `${line.variation_id}-${index}`">
                        ...
                        <td class="is-money">
                            <div class="purchase-lines__control is-money">
                                ...
                                <input
                                    ...
                                    :disabled="disabled"
                                    @input="emit('update', index, { unit_price: ($event.target as HTMLInputElement).value })"
                                >
                            </div>
                        </td>
                        <td class="is-money">
                        ...
                        <td class="is-money">
                            <span class="purchase-lines__amount">
                                ...
                                {{ formatAmount(line.unit_price_after_discount) }}
                            </span>
                        </td>
                        <td class="is-money">
