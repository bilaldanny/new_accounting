<script setup lang="ts">
    ...
    import { Shield, SliderAlt, Store } from '@boxicons/vue';
    ...
    const nameRules = computed(() => {
        if (params.recordId) {
            return `required|min:2|max:200|warranty_name_unique:${params.recordId}`;
        }

        return 'required|min:2|max:200|warranty_name_unique';
    });
...
<template>
    ...
    <StaticElement v-if="showCompanyField" name="section_scope" :columns="colFull">
        <div class="company-section-header company-section-header-primary">
            ...
            <div>
                ...
                <p class="company-section-subtitle mb-0">Assign this warranty plan to the correct company workspace</p>
            </div>
        </div>
    </StaticElement>
    ...
    <SelectElement
        ...
        :can-clear="false"
        :rules="companyRules"
        info="Required. Warranty plans are scoped to a single company."
    />
    ...
    <StaticElement name="section_details" :columns="colFull">
        <div class="company-section-header company-section-header-indigo company-section-header-spaced">
            ...
            <div>
                <h6 class="company-section-title mb-0">Warranty Details</h6>
                <p class="company-section-subtitle mb-0">Define the coverage name and protection period</p>
            </div>
        </div>
    </StaticElement>
    ...
    <TextElement
        ...
        name="name"
        label="Warranty Name"
        placeholder="e.g. Standard Warranty, Extended 2-Year Plan"
        :columns="colThird"
        autocomplete="off"
        :rules="nameRules"
        info="A clear label that staff will recognize when assigning warranties to products."
    />
    ...
    <TextElement
        ...
        info="Enter a whole number — for example, 12 months or 2 years."
    />
    ...
    <SelectElement
        ...
        :can-clear="false"
        :default="'day'"
        rules="required|in:day,month,year"
        info="Choose whether the duration is measured in days, months, or years."
    />
    ...
    <StaticElement name="section_settings" :columns="colFull">
        <div class="company-section-header company-section-header-teal company-section-header-spaced">
            ...
            <div>
                ...
                <p class="company-section-subtitle mb-0">Control whether this warranty appears in product forms</p>
            </div>
        </div>
    </StaticElement>
    ...
    <ToggleElement
        ...
        :false-value="false"
        :default="true"
        info="Inactive warranties are hidden from product add and edit screens."
    />
</template>
