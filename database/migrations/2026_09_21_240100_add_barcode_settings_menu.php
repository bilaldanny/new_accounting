...
/**
 * The Barcode Settings page in the Company Settings group, with the hidden permission rows its controller and pages
 * check: update.
 *
...
{
    private const PATH = '/barcode/settings';
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Update Barcode Settings', 'barcode.settings.update', '/barcode/settings/update'],
        ];
