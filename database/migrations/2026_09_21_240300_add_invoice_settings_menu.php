...
/**
 * The Invoice Settings page in the Company Settings group, with the hidden permission rows its controller and pages
 * check: update.
 *
...
{
    private const PATH = '/invoice/settings';
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Update Invoice Settings', 'invoice.settings.update', '/invoice/settings/update'],
        ];
