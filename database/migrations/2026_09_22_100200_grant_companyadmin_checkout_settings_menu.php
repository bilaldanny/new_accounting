 ...
 * created with) the Checkout Extras page and its hidden rows (update):
 * 2 `permissions` rows.
 *
 * 2026_09_22_100100_add_checkout_settings_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
