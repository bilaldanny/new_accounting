 ...
 * created with) the Loyalty Points page and its hidden rows (view, settings, earn, redeem, adjust, export):
 * 7 `permissions` rows.
 *
 * 2026_09_21_220100_add_loyalty_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
