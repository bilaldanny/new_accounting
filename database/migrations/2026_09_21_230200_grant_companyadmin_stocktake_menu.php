 ...
 * created with) the Stock Take page and its hidden rows (add, view, count, complete, delete, restore, export):
 * 8 `permissions` rows.
 *
 * 2026_09_21_230100_add_stocktake_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
