 ...
 * created with) the Gift Card page and its hidden rows (add, edit, delete, view, restore, export, redeem, topup):
 * 9 `permissions` rows.
 *
 * 2026_09_21_210100_add_giftcard_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
