...
/**
 * The Discount page in the Sell group, with the hidden permission rows its controller and pages
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Add Discount', 'discount.add', '/discount/add'],
            ['Edit Discount', 'discount.edit', '/discount/:id/edit'],
            ['Delete Discount', 'discount.delete', '/discount/delete'],
            ['View Discount', 'discount.view', '/discount/:id/view'],
            ['Restore Discount', 'discount.restore', '/discount/restore'],
            ['Discount Export', 'discount.export', '/discount/export'],
        ];
