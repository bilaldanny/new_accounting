 ...
 * the two Cash Collection rows added by 2026_09_23_110100_add_cashcollection_reverse_and_advance_menus: Reverse
 * and Advance (2 permissions rows). Idempotent (an existing row is re-enabled, a missing one added), a menu row that
 * does not exist is skipped, and down() removes only these rows. Superadmin is always allowed; other roles are left alone.
 */
return new class extends Migration
{
     ...
     */
    private const PATHS = [
        '/cashcollection/reverse',
        '/cashcollection/advance',
    ];
