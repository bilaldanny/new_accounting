...
class CreatePurchaseLinesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_lines', function (Blueprint $table) {
            ...
            $table->double('quantity_received', 9, 2)->default(0);
            $table->double('qunatity_sold', 9, 2)->default(0);
            $table->double('quantity_returned', 9, 2)->default(0);
            $table->double('purchase_rate', 9, 2)->default(0);
            $table->double('default_sell_price', 9, 2)->default(0);
            $table->double('discount_percent', 9, 2)->default(0);
            $table->double('margin', 9, 2)->default(0);
            $table->double('quantity_adjustment', 9, 2)->default(0);
            $table->double('pp_without_discount', 9, 2)->default(0);
