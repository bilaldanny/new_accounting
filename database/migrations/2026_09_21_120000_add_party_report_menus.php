...
/**
 * The party reports under the Reports group: customer and supplier outstanding, customer & supplier
 * summary, customer group, and customer and supplier aging. Each page also gets the
 * hidden `/report/<name>/export` row that the table's Export buttons check.
 *
...
return new class extends Migration
{
    ...
    private const REPORTS = [
        '/report/customer-outstanding' => 'Customer Outstanding Report',
        '/report/supplier-outstanding' => 'Supplier Outstanding Report',
        '/report/customer-supplier' => 'Customer & Supplier Report',
        '/report/customer-group' => 'Customer Group Report',
        '/report/customer-aging' => 'Customer Aging Report',
        '/report/supplier-aging' => 'Supplier Aging Report',
    ];
