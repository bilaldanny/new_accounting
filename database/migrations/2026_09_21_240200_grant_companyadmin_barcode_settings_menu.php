 ...
 * created with) the Barcode Settings page and its hidden rows (update):
 * 2 `permissions` rows.
 *
 * 2026_09_21_240100_add_barcode_settings_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
