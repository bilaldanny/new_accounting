...
/**
 * The Checkout Extras page in the Company Settings group, with the hidden permission rows its controller and pages
 * check: update.
 *
...
{
    private const PATH = '/checkout/settings';
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Update Checkout Extras', 'checkout.settings.update', '/checkout/settings/update'],
        ];
