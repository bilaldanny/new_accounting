 ...
 * the API Keys page and its two hidden rows (add, delete): 3 permissions rows. 2026_09_23_130100_add_apikeys_menu only adds
 * the menu rows. Idempotent (an existing row is re-enabled, a missing one added), a menu row that does not exist is
 * skipped, and down() removes only these rows. Superadmin is always allowed; other roles are left alone.
 */
