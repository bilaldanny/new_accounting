...
/**
 * The product and tax reports under the Reports group: product purchase and sell, product sell summary,
 * item profit and loss, item purchase and sell, purchase & sale, tax and trending products. Each page
 * also gets the hidden `/report/<name>/export` row that the table's Export buttons check.
 *
...
return new class extends Migration
{
    ...
    private const REPORTS = [
        '/report/product-purchase' => 'Product Purchase Report',
        '/report/product-sell' => 'Product Sell Report',
        '/report/product-sell-summary' => 'Product Sell Summary',
        '/report/item-profit-loss' => 'Item Profit & Loss Report',
        '/report/item-purchase' => 'Item Purchase Report',
        '/report/item-sell' => 'Item Sell Report',
        '/report/purchase-sale' => 'Purchase & Sale Report',
        '/report/tax' => 'Tax Report',
        '/report/trending-products' => 'Trending Products Report',
    ];
