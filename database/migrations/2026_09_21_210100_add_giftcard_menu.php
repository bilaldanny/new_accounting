...
/**
 * The Gift Card page in the Sell group, with the hidden permission rows its controller and pages
 * check: add, edit, delete, view, restore (from the trash page), export, redeem, topup.
 *
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Add Gift Card', 'giftcard.add', '/giftcard/add'],
            ['Edit Gift Card', 'giftcard.edit', '/giftcard/:id/edit'],
            ['Delete Gift Card', 'giftcard.delete', '/giftcard/delete'],
            ['View Gift Card', 'giftcard.view', '/giftcard/:id/view'],
            ['Restore Gift Card', 'giftcard.restore', '/giftcard/restore'],
            ['Gift Card Export', 'giftcard.export', '/giftcard/export'],
            ['Redeem Gift Card', 'giftcard.redeem', '/giftcard/redeem'],
            ['Top Up Gift Card', 'giftcard.topup', '/giftcard/topup'],
        ];
