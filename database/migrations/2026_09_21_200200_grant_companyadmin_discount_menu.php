 ...
 * created with) the Discount page and its hidden rows (add, edit, delete, view, restore, export):
 * 7 `permissions` rows.
 *
 * 2026_09_21_200100_add_discount_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
