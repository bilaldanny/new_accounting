...
/**
 * The Cash Collection page in the Sell group, with the hidden permission rows its controller and pages
 * check: add, edit, delete, view, restore, export, complete, cancel.
 *
...
{
    private const PATH = '/cashcollection';
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Add Cash Collection', 'cashcollection.add', '/cashcollection/add'],
            ['Edit Cash Collection', 'cashcollection.edit', '/cashcollection/:id/edit'],
            ['Delete Cash Collection', 'cashcollection.delete', '/cashcollection/delete'],
            ['View Cash Collection', 'cashcollection.view', '/cashcollection/:id/view'],
            ['Restore Cash Collection', 'cashcollection.restore', '/cashcollection/restore'],
            ['Cash Collection Export', 'cashcollection.export', '/cashcollection/export'],
            ['Complete Cash Collection', 'cashcollection.complete', '/cashcollection/complete'],
            ['Cancel Cash Collection', 'cashcollection.cancel', '/cashcollection/cancel'],
        ];
