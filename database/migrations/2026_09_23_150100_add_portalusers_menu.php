...
/**
 * The Portal Users page in the Settings group, with its hidden permission rows (add, delete). The Settings group is a
 * legacy row that only exists in live data, so it is found through the Settings page (/software/setting) and the
 * migration does nothing without it. Permissions are not granted here (see the companyadmin grant migration).
 */
return new class extends Migration
{
    private const PATH = '/portalusers';
    ...
    public function up(): void
    {
        ...
        $children = [
            ['Create Portal User', 'portalusers.add', '/portalusers/add'],
            ['Remove Portal User', 'portalusers.delete', '/portalusers/delete'],
        ];
