 ...
 * created with) the Invoice Settings page and its hidden rows (update):
 * 2 `permissions` rows.
 *
 * 2026_09_21_240300_add_invoice_settings_menu only adds the menu rows; roles get `permissions` rows through the Role Permission
