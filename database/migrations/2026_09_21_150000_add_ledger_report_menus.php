...
/**
 * The accounts reports under the Reports group: the general ledger of any account, the trial balance and the
 * receipts & payments voucher report. Each page also gets the hidden `/report/<name>/export` row that the
 * table's Export buttons check.
 *
...
return new class extends Migration
{
    ...
    private const REPORTS = [
        '/report/account-ledger' => 'Account Ledger',
        '/report/trial-balance' => 'Trial Balance',
        '/report/vouchers' => 'Receipts & Payments Report',
    ];
