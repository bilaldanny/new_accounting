...
/**
 * The transaction list reports under the Reports group: purchase, purchase return, sell, sell
 * return, purchase payment, sell payment, stock adjustment and expense. Each page also gets the
...
return new class extends Migration
{
    ...
    private const REPORTS = [
        ...
        '/report/purchase-return' => 'Purchase Return Report',
        '/report/sell' => 'Sell Report',
        '/report/sell-return' => 'Sell Return Report',
        '/report/purchase-payment' => 'Purchase Payment Report',
        '/report/sell-payment' => 'Sell Payment Report',
        '/report/stock-adjustment' => 'Stock Adjustment Report',
