...
class PurchaseReturnController extends Controller
{
    ...
    protected function purchaseReturnRules(): array
    {
        return [
            ...
            'purchaselines.*.quantity_returned' => 'bail|required|numeric|min:0',
        ];
    }
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => Transaction::paginatePurchaseReturns($filters),
            'trash_count' => Transaction::onlyTrashed()->purchaseReturns()->visibleToCurrentUser()->count(),
        ]);
    }
    ...
    public function eligiblePurchases(Request $request): JsonResponse
    {
        ...
        return response()->json(Transaction::eligibleReturnPurchases(
            $companyId,
    ...
    public function purchaseLines(int $id): JsonResponse
    {
        ...
        return response()->json([
            ...
            'purchaselines' => $purchase->purchaseReturnLines(),
        ]);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        DB::beginTransaction();
        try {
            Transaction::createPurchaseReturn($request);
            DB::commit();
    ...
    {
        $note = Transaction::findVisiblePurchaseReturn($id);

        if ($note === null) {
            abort(404);
        }

        return response()->json($note->presentPurchaseReturn());
    }
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        DB::beginTransaction();
        try {
            Transaction::updatePurchaseReturn($request, $id);
            DB::commit();
        } catch (ValidationException $e) {
            DB::rollBack();
            throw $e;
